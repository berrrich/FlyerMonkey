...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "FlyerMonkey.dll" comes first in this list. */
		"FlyerMonkey.dll",
		...
		"Syncfusion.Blazor.SfPdfViewer.dll",
		...
		"Syncfusion.SfPdfViewer.AspNet.Core.dll",
